<template>
  <div class="settings-section">
    <div class="section-header">
      <div>
        <h3>下载器配置</h3>
        <p class="section-description">管理下载器连接和配置</p>
      </div>
      <el-button type="primary" :icon="Plus" @click="showAddDialog">添加下载器</el-button>
    </div>
    ...
    <!-- 空状态 -->
    <el-empty v-if="!loading && downloaders.length === 0" description="暂无下载器配置" style="margin-top: 20px">
      <el-button type="primary" @click="showAddDialog">添加第一个下载器</el-button>
    </el-empty>
