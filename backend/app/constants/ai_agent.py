...
AGENT_TOOL_SITE_MANAGE = "site_manage"
AGENT_TOOL_ORGANIZE_MEDIA = "organize_media"
AGENT_TOOL_WATCH_HISTORY = "watch_history"
AGENT_TOOL_LIST_DIRECTORY = "list_directory"
AGENT_TOOL_READ_FILE = "read_file"
...
AGENT_TOOLS = [
    ...
    AGENT_TOOL_SITE_MANAGE,
    AGENT_TOOL_ORGANIZE_MEDIA,
    AGENT_TOOL_WATCH_HISTORY,
...
AGENT_TOOL_DISPLAY_NAMES = {
    ...
    AGENT_TOOL_SITE_MANAGE: "站点运维",
    AGENT_TOOL_ORGANIZE_MEDIA: "媒体整理",
    AGENT_TOOL_WATCH_HISTORY: "观看历史",
    AGENT_TOOL_LIST_DIRECTORY: "列出目录",
    AGENT_TOOL_READ_FILE: "读取文件",
